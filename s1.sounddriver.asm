...
sub_7272E:				; XREF: loc_71E6A
        lea    ($A04000).l,a0
WriteFMILoop1:        btst    #7,(a0)
        bne.s    WriteFMILoop1
        move.b    d0,(a0)
WriteFMILoop2:        btst    #7,(a0)
        bne.s    WriteFMILoop2
        move.b    d1,1(a0)
        rts
		rts	
...
sub_72764:				; XREF: loc_71E6A; Sound_ChkValue; sub_7256A; sub_72764
        lea    ($A04000).l,a0
WriteFMIILoop1:        btst    #7,(a0)
        bne.s    WriteFMIILoop1
        move.b    d0,2(a0)
WriteFMIILoop2:        btst    #7,(a0)
        bne.s    WriteFMIILoop2
        move.b    d1,3(a0)
		rts	
...
SoundB4:	incbin	sound\soundB4.bin
		even
SoundB5:	include	sfx\soundB5.asm
		even
...
SoundCD:	incbin	sound\soundCD.bin
		even
SoundCE:	include	sfx\soundCE.asm
		even
