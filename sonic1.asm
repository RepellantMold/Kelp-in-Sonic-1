...
; ---------------------------------------------------------------------------
; Subroutine to    play a sound or    music track if on-screen
; ---------------------------------------------------------------------------
...
PlaySound_Local:
        tst.b    1(a0)
        bpl.s    PlaySound_SpecialEnd


PlaySound_Special:
		move.b	d0,($FFFFF00B).w
PlaySound_SpecialEnd:
		rts	
...
ExtraLife:
		...
		addq.b	#1,($FFFFFE1C).w ; add 1 to the	lives counter
		move.w	#$88,d0
		jmp	(PlaySound_Unk).l	; play extra life music
; ===========================================================================
...
byte_CBEA:	dc.b $A	;  SONIC HAS | KELPYY HAS
		dc.b $F8, 5, 0, $22, $B0	; K
		dc.b $F8, 5, 0, $10, $C0	; E
		dc.b $F8, 5, 0, $26, $D0	; L
		dc.b $F8, 5, 0, $36, $E0	; P
...
loc_13A9C:
		lea	(SonAni_Walk).l,a1 ; use	running	animation
...
Obj09_Get1Up:
		...
		move.w	#$88,d0
		jsr	(PlaySound_Unk).l	; play extra life music
		moveq	#0,d4
		rts	
; ===========================================================================
